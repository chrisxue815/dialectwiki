...
<div class="lefth2">
恭喜，成功添加词条“ <span id="word_name"><a href="<%=path %>/word?name=<s:property value="wordname" />"><s:property value="wordname" /></a></span> ”，
下面您可以为它发音或者添加新词条
</div>
<div class="alert">
...
<div class="lefth3">
词条：
<s:form action="/addword" method="post" theme="simple">
