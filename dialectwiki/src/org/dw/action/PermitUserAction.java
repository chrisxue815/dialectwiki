...
public class PermitUserAction extends ActionSupport {

	private static final long serialVersionUID = 237833883366875769L;
	...
	public String execute()
	{
		try
		{
			if(id != null && id != "")
			{
				...
				authorityService.enableUserAuthority(user);
			}
